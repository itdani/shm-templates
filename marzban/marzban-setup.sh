...
cd /opt/marzban
curl -sLO https://github.com/itdani/shm-templates/raw/main/marzban/docker-compose.yml
curl -sLO https://github.com/itdani/shm-templates/raw/main/marzban/template_subscription_index.html
echo "done"
